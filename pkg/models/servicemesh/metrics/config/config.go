...
import (
	...
	"kubesphere.io/kubesphere/pkg/models/servicemesh/metrics/config/security"
...
func NewConfig() (c *Config) {
	...
	c.Server.StaticContentRootDirectory = strings.TrimSpace(getDefaultString(EnvServerStaticContentRootDirectory, "/opt/metrics/console"))
	...
	c.LoginToken.SigningKey = []byte(strings.TrimSpace(getDefaultString(EnvLoginTokenSigningKey, "metrics")))
