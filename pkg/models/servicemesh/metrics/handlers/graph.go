...
import (
	...
	"kubesphere.io/kubesphere/pkg/models/servicemesh/metrics/graph/appender"
	"kubesphere.io/kubesphere/pkg/models/servicemesh/metrics/graph/cytoscape"
	"kubesphere.io/kubesphere/pkg/models/servicemesh/metrics/graph/options"
	...
	"kubesphere.io/kubesphere/pkg/models/servicemesh/metrics/prometheus/internalmetrics"
)
...
func addServiceGraphTraffic(toEdge, fromEdge *graph.Edge) {
	...
	// we can't average quantiles (metrics-2297).
}
