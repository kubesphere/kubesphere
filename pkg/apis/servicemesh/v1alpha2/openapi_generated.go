...
func schema_pkg_apis_servicemesh_v1alpha2_DestinationRuleSpecTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/knative/pkg/apis/istio/v1alpha3.DestinationRuleSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/knative/pkg/apis/istio/v1alpha3.DestinationRuleSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_servicemesh_v1alpha2_VirtualServiceTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/knative/pkg/apis/istio/v1alpha3.VirtualServiceSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/knative/pkg/apis/istio/v1alpha3.VirtualServiceSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
