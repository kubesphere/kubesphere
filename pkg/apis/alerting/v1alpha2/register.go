...
func addWebService(c *restful.Container) error {
	...
	ws.Route(ws.GET("/resource_type").To(alerting.DescribeResourceTypes).
	...
	ws.Route(ws.PATCH("/workspaces/{ws_name}/policy").To(alerting.ModifyPolicyByAlertWorkspace).
		Doc("Modify Policy By Alert Workspace Level").
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/policy").To(alerting.ModifyPolicyByAlertNamespace).
		Doc("Modify Policy By Alert Namespace Level").
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/workloads/policy").To(alerting.ModifyPolicyByAlertWorkload).
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/pods/policy").To(alerting.ModifyPolicyByAlertPod).
	...
	ws.Route(ws.PATCH("/nodes/{node_id}/pods/policy").To(alerting.ModifyPolicyByAlertPod).
		Doc("Modify Policy By Alert Pod Level").
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/pods/{pod_name}/containers/policy").To(alerting.ModifyPolicyByAlertContainer).
	...
	ws.Route(ws.PATCH("/nodes/{node_id}/pods/{pod_name}/containers/policy").To(alerting.ModifyPolicyByAlertContainer).
		Doc("Modify Policy By Alert Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.POST("/workspaces/{ws_name}/alert").To(alerting.CreateAlertWorkspace).
		Doc("Create Alert Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.AlertInfo{}).
	...
	ws.Route(ws.POST("/namespaces/{ns_name}/alert").To(alerting.CreateAlertNamespace).
		Doc("Create Alert Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.AlertInfo{}).
	...
	ws.Route(ws.POST("/namespaces/{ns_name}/workloads/alert").To(alerting.CreateAlertWorkload).
	...
	ws.Route(ws.POST("/namespaces/{ns_name}/pods/alert").To(alerting.CreateAlertPod).
	...
	ws.Route(ws.POST("/nodes/{node_id}/pods/alert").To(alerting.CreateAlertPod).
		Doc("Create Alert Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.AlertInfo{}).
	...
	ws.Route(ws.POST("/namespaces/{ns_name}/pods/{pod_name}/containers/alert").To(alerting.CreateAlertContainer).
	...
	ws.Route(ws.POST("/nodes/{node_id}/pods/{pod_name}/containers/alert").To(alerting.CreateAlertContainer).
		Doc("Create Alert Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.PATCH("/workspaces/{ws_name}/alert").To(alerting.ModifyAlertByNameWorkspace).
		Doc("Modify Alert By Name Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.Alert{}).
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/alert").To(alerting.ModifyAlertByNameNamespace).
		Doc("Modify Alert By Name Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.Alert{}).
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/workloads/alert").To(alerting.ModifyAlertByNameWorkload).
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/pods/alert").To(alerting.ModifyAlertByNamePod).
	...
	ws.Route(ws.PATCH("/nodes/{node_id}/pods/alert").To(alerting.ModifyAlertByNamePod).
		Doc("Modify Alert By Name Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
		Reads(models.Alert{}).
	...
	ws.Route(ws.PATCH("/namespaces/{ns_name}/pods/{pod_name}/containers/alert").To(alerting.ModifyAlertByNameContainer).
	...
	ws.Route(ws.PATCH("/nodes/{node_id}/pods/{pod_name}/containers/alert").To(alerting.ModifyAlertByNameContainer).
		Doc("Modify Alert By Name Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.DELETE("/workspaces/{ws_name}/alert").To(alerting.DeleteAlertsByNameWorkspace).
		Doc("Delete Alerts By Name Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_names", "Specify alert names to delete, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.DELETE("/namespaces/{ns_name}/alert").To(alerting.DeleteAlertsByNameNamespace).
		Doc("Delete Alerts By Name Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_names", "Specify alert names to delete, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.DELETE("/namespaces/{ns_name}/workloads/alert").To(alerting.DeleteAlertsByNameWorkload).
	...
	ws.Route(ws.DELETE("/namespaces/{ns_name}/pods/alert").To(alerting.DeleteAlertsByNamePod).
	...
	ws.Route(ws.DELETE("/nodes/{node_id}/pods/alert").To(alerting.DeleteAlertsByNamePod).
		Doc("Delete Alerts By Name Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_names", "Specify alert names to delete, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.DELETE("/namespaces/{ns_name}/pods/{pod_name}/containers/alert").To(alerting.DeleteAlertsByNameContainer).
	...
	ws.Route(ws.DELETE("/nodes/{node_id}/pods/{pod_name}/containers/alert").To(alerting.DeleteAlertsByNameContainer).
		Doc("Delete Alerts By Name Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_names", "Specify alert names to delete, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/workspaces/{ws_name}/alert").To(alerting.DescribeAlertDetailsWorkspace).
		Doc("Describe Alert Details Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/alert").To(alerting.DescribeAlertDetailsNamespace).
		Doc("Describe Alert Details Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/workloads/alert").To(alerting.DescribeAlertDetailsWorkload).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/alert").To(alerting.DescribeAlertDetailsPod).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/alert").To(alerting.DescribeAlertDetailsPod).
		Doc("Describe Alert Details Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/{pod_name}/containers/alert").To(alerting.DescribeAlertDetailsContainer).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/{pod_name}/containers/alert").To(alerting.DescribeAlertDetailsContainer).
		Doc("Describe Alert Details Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/workspaces/{ws_name}/alert_status").To(alerting.DescribeAlertStatusWorkspace).
		Doc("Describe Alert Status Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_names", "Specify alert names to query, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/alert_status").To(alerting.DescribeAlertStatusNamespace).
		Doc("Describe Alert Status Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_names", "Specify alert names to query, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/workloads/alert_status").To(alerting.DescribeAlertStatusWorkload).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/alert_status").To(alerting.DescribeAlertStatusPod).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/alert_status").To(alerting.DescribeAlertStatusPod).
		Doc("Describe Alert Status Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
		Param(ws.QueryParameter("alert_names", "Specify alert names to query, comma-separated, eg. alert-1,alert-2.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/{pod_name}/containers/alert_status").To(alerting.DescribeAlertStatusContainer).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/{pod_name}/containers/alert_status").To(alerting.DescribeAlertStatusContainer).
		Doc("Describe Alert Status Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("alert_ids", "Specify alert ids to query, comma-separated, eg. al-WgBBMmRv3rMP,al-QVjOxnkD3mwW.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/workspaces/{ws_name}/history").To(alerting.DescribeHistoryDetailWorkspace).
		Doc("Describe History Detail Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("history_ids", "Specify history ids to query, comma-separated, eg. hs-zzz8NpjopLvj,hs-zzzlXz1ELM6y.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/history").To(alerting.DescribeHistoryDetailNamespace).
		Doc("Describe History Detail Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("history_ids", "Specify history ids to query, comma-separated, eg. hs-zzz8NpjopLvj,hs-zzzlXz1ELM6y.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/workloads/history").To(alerting.DescribeHistoryDetailWorkload).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/history").To(alerting.DescribeHistoryDetailPod).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/history").To(alerting.DescribeHistoryDetailPod).
		Doc("Describe History Detail Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
		Param(ws.QueryParameter("history_ids", "Specify history ids to query, comma-separated, eg. hs-zzz8NpjopLvj,hs-zzzlXz1ELM6y.").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/{pod_name}/containers/history").To(alerting.DescribeHistoryDetailContainer).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/{pod_name}/containers/history").To(alerting.DescribeHistoryDetailContainer).
		Doc("Describe History Detail Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("search_word", "Specify search word").DataType("string").Required(false)).
	...
	ws.Route(ws.GET("/workspaces/{ws_name}/resource").To(alerting.DescribeResourcesWorkspace).
		Doc("Describe Resources Workspace Level").
		Param(ws.PathParameter("ws_name", "Specify workspace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("selector", "Specify selector, eg. [{\"app\": \"fluentbit-operator\"}]").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/resource").To(alerting.DescribeResourcesNamespace).
		Doc("Describe Resources Namespace Level").
		Param(ws.PathParameter("ns_name", "Specify namespace").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("selector", "Specify selector, eg. [{\"app\": \"fluentbit-operator\"}]").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/workloads/resource").To(alerting.DescribeResourcesWorkload).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/resource").To(alerting.DescribeResourcesPod).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/resource").To(alerting.DescribeResourcesPod).
		Doc("Describe Resources Pod Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("selector", "Specify selector, eg. [{\"app\": \"fluentbit-operator\"}]").DataType("string").Required(false)).
		Metadata(restfulspec.KeyOpenAPITags, tags).
	...
	ws.Route(ws.GET("/namespaces/{ns_name}/pods/{pod_name}/containers/resource").To(alerting.DescribeResourcesContainer).
	...
	ws.Route(ws.GET("/nodes/{node_id}/pods/{pod_name}/containers/resource").To(alerting.DescribeResourcesContainer).
		Doc("Describe Resources Container Level").
		Param(ws.PathParameter("node_id", "Specify node id").DataType("string").Required(true).DefaultValue("")).
		Param(ws.PathParameter("pod_name", "Specify pod").DataType("string").Required(true).DefaultValue("")).
		Param(ws.QueryParameter("selector", "Specify selector, eg. [{\"app\": \"fluentbit-operator\"}]").DataType("string").Required(false)).
