...
func NewClusterDispatcher(clusterInformer clusterinformer.ClusterInformer) Dispatcher {
	return &clusterDispatcher{clusterclient.NewClusterClient(clusterInformer)}
}

// Dispatch dispatch requests to designated cluster
func (c *clusterDispatcher) Dispatch(w http.ResponseWriter, req *http.Request) bool {
...
func (c *clusterDispatcher) Error(w http.ResponseWriter, req *http.Request, err error) {
