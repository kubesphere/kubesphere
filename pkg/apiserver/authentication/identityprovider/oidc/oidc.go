...
func init() {
	identityprovider.RegisterOAuthProvider(&oidcProvider{})
}
...
type oidcProvider struct {
	...
	// Used to turn off ID Token verify
	IDTokenSkipVerify bool `json:"idTokenSkipVerify" yaml:"idTokenSkipVerify"`
...
func (o *oidcProvider) Setup(options *oauth.DynamicOptions) (identityprovider.OAuthProvider, error) {
