...
func AddToContainer(c *restful.Container, informerFactory informers.InformerFactory, cache client.Reader, cli client.Client) error {

	webservice := runtime.NewWebService(GroupVersion)
	handler := New(resourcev1alpha3.NewResourceGetter(informerFactory, cli.Scheme(), cache), resourcev1alpha2.NewResourceGetter(informerFactory), components.NewComponentsGetter(informerFactory.KubernetesSharedInformerFactory()))
