...
func (h handler) handleMetricLabelsQuery(req *restful.Request, resp *restful.Response) {
	var res monitoring.MetricLabels
	...
	res = h.mo.GetMetricLabels(params.metric, params.namespaceName, opt.start, opt.end)
	resp.WriteAsJson(res)
}
