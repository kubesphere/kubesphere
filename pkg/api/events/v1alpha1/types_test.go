...
func TestParseQueryParameter(t *testing.T) {
	queryParam := "/tenant.kubesphere.io/v2alpha1/events?operation=query&workspace_filter=my-ws,demo-ws&workspace_search=my,demo&start_time=1136214245&end_time=1136214245&from=0"
