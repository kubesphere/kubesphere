...
type IPAMBlockInterface interface {
	Create(ctx context.Context, iPAMBlock *v1alpha1.IPAMBlock, opts v1.CreateOptions) (*v1alpha1.IPAMBlock, error)
	Update(ctx context.Context, iPAMBlock *v1alpha1.IPAMBlock, opts v1.UpdateOptions) (*v1alpha1.IPAMBlock, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.IPAMBlock, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.IPAMBlockList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IPAMBlock, err error)
	IPAMBlockExpansion
}
...
func (c *iPAMBlocks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IPAMBlock, err error) {
...
func (c *iPAMBlocks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IPAMBlockList, err error) {
...
func (c *iPAMBlocks) Create(ctx context.Context, iPAMBlock *v1alpha1.IPAMBlock, opts v1.CreateOptions) (result *v1alpha1.IPAMBlock, err error) {
	result = &v1alpha1.IPAMBlock{}
	err = c.client.Post().
		Resource("ipamblocks").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *iPAMBlocks) Update(ctx context.Context, iPAMBlock *v1alpha1.IPAMBlock, opts v1.UpdateOptions) (result *v1alpha1.IPAMBlock, err error) {
	result = &v1alpha1.IPAMBlock{}
	err = c.client.Put().
		Resource("ipamblocks").
		Name(iPAMBlock.Name).
...
func (c *iPAMBlocks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IPAMBlock, err error) {
	result = &v1alpha1.IPAMBlock{}
