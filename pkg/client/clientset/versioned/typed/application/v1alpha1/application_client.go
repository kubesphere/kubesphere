...
func (c *ApplicationV1alpha1Client) HelmAudits() HelmAuditInterface {
	return newHelmAudits(c)
}
...
func (c *ApplicationV1alpha1Client) HelmReleases(namespace string) HelmReleaseInterface {
