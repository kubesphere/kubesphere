...
func (c *FakeApplicationV1alpha1) HelmAudits() v1alpha1.HelmAuditInterface {
	return &FakeHelmAudits{c}
}
...
func (c *FakeApplicationV1alpha1) HelmReleases(namespace string) v1alpha1.HelmReleaseInterface {
