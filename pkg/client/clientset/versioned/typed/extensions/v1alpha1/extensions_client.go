...
type ExtensionsV1alpha1Interface interface {
	...
	JSBundlesGetter
	RepositoriesGetter
	ReverseProxiesGetter
	SubscriptionsGetter
}

// ExtensionsV1alpha1Client is used to interact with features provided by the extensions.kubesphere.io group.
type ExtensionsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExtensionsV1alpha1Client) APIServices() APIServiceInterface {
	return newAPIServices(c)
}

func (c *ExtensionsV1alpha1Client) Categories() CategoryInterface {
	return newCategories(c)
}

func (c *ExtensionsV1alpha1Client) JSBundles() JSBundleInterface {
	return newJSBundles(c)
}

func (c *ExtensionsV1alpha1Client) Repositories() RepositoryInterface {
	return newRepositories(c)
}

func (c *ExtensionsV1alpha1Client) ReverseProxies() ReverseProxyInterface {
	return newReverseProxies(c)
}

func (c *ExtensionsV1alpha1Client) Subscriptions() SubscriptionInterface {
	return newSubscriptions(c)
}
