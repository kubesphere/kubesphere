...
var rulesResource = schema.GroupVersionResource{Group: "admission.kubesphere.io", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "admission.kubesphere.io", Version: "v1alpha1", Kind: "Rule"}
...
func (c *FakeRules) UpdateStatus(ctx context.Context, rule *v1alpha1.Rule, opts v1.UpdateOptions) (*v1alpha1.Rule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(rulesResource, "status", rule), &v1alpha1.Rule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Rule), err
