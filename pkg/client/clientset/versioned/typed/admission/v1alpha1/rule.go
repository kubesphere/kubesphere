...
func newRules(c *AdmissionV1alpha1Client) *rules {
	return &rules{
		client: c.RESTClient(),
	}
}
...
func (c *rules) UpdateStatus(ctx context.Context, rule *v1alpha1.Rule, opts v1.UpdateOptions) (result *v1alpha1.Rule, err error) {
	result = &v1alpha1.Rule{}
	err = c.client.Put().
		Resource("rules").
		Name(rule.Name).
