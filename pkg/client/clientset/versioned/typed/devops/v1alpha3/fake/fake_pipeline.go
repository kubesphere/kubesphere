...
func (c *FakePipelines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.Pipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakePipelines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.PipelineList, err error) {
	obj, err := c.Fake.
...
func (c *FakePipelines) Create(ctx context.Context, pipeline *v1alpha3.Pipeline, opts v1.CreateOptions) (result *v1alpha3.Pipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakePipelines) Update(ctx context.Context, pipeline *v1alpha3.Pipeline, opts v1.UpdateOptions) (result *v1alpha3.Pipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakePipelines) UpdateStatus(ctx context.Context, pipeline *v1alpha3.Pipeline, opts v1.UpdateOptions) (*v1alpha3.Pipeline, error) {
	obj, err := c.Fake.
...
func (c *FakePipelines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.Pipeline, err error) {
	obj, err := c.Fake.
