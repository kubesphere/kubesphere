...
func (c *FakeResourceQuotas) Get(name string, options v1.GetOptions) (result *v1alpha2.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) List(opts v1.ListOptions) (result *v1alpha2.ResourceQuotaList, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) Create(resourceQuota *v1alpha2.ResourceQuota) (result *v1alpha2.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) Update(resourceQuota *v1alpha2.ResourceQuota) (result *v1alpha2.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) UpdateStatus(resourceQuota *v1alpha2.ResourceQuota) (*v1alpha2.ResourceQuota, error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(resourcequotasResource, listOptions)
...
func (c *FakeResourceQuotas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ResourceQuota, err error) {
	obj, err := c.Fake.
