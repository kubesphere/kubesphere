...
func (c *FakeFederatedServices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FederatedServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFederatedServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeFederatedServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(federatedservicesResource, c.ns, listOpts)
