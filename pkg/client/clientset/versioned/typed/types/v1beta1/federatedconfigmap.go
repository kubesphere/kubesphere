...
func (c *federatedConfigMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.FederatedConfigMap, err error) {
...
func (c *federatedConfigMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FederatedConfigMapList, err error) {
...
func (c *federatedConfigMaps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *federatedConfigMaps) Create(ctx context.Context, federatedConfigMap *v1beta1.FederatedConfigMap, opts v1.CreateOptions) (result *v1beta1.FederatedConfigMap, err error) {
	result = &v1beta1.FederatedConfigMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedconfigmaps").
...
func (c *federatedConfigMaps) Update(ctx context.Context, federatedConfigMap *v1beta1.FederatedConfigMap, opts v1.UpdateOptions) (result *v1beta1.FederatedConfigMap, err error) {
	result = &v1beta1.FederatedConfigMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedconfigmaps").
...
func (c *federatedConfigMaps) UpdateStatus(ctx context.Context, federatedConfigMap *v1beta1.FederatedConfigMap, opts v1.UpdateOptions) (result *v1beta1.FederatedConfigMap, err error) {
	result = &v1beta1.FederatedConfigMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedconfigmaps").
...
func (c *federatedConfigMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *federatedConfigMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *federatedConfigMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.FederatedConfigMap, err error) {
	result = &v1beta1.FederatedConfigMap{}
