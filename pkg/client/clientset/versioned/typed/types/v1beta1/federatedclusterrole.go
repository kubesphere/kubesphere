...
func (c *federatedClusterRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.FederatedClusterRole, err error) {
...
func (c *federatedClusterRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FederatedClusterRoleList, err error) {
...
func (c *federatedClusterRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *federatedClusterRoles) Create(ctx context.Context, federatedClusterRole *v1beta1.FederatedClusterRole, opts v1.CreateOptions) (result *v1beta1.FederatedClusterRole, err error) {
	result = &v1beta1.FederatedClusterRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedclusterroles").
...
func (c *federatedClusterRoles) Update(ctx context.Context, federatedClusterRole *v1beta1.FederatedClusterRole, opts v1.UpdateOptions) (result *v1beta1.FederatedClusterRole, err error) {
	result = &v1beta1.FederatedClusterRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedclusterroles").
...
func (c *federatedClusterRoles) UpdateStatus(ctx context.Context, federatedClusterRole *v1beta1.FederatedClusterRole, opts v1.UpdateOptions) (result *v1beta1.FederatedClusterRole, err error) {
	result = &v1beta1.FederatedClusterRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedclusterroles").
...
func (c *federatedClusterRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *federatedClusterRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *federatedClusterRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.FederatedClusterRole, err error) {
	result = &v1beta1.FederatedClusterRole{}
