...
type Interface interface {
	...
	// HelmAudits returns a HelmAuditInformer.
	HelmAudits() HelmAuditInformer
...
// HelmAudits returns a HelmAuditInformer.
func (v *version) HelmAudits() HelmAuditInformer {
	return &helmAuditInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
