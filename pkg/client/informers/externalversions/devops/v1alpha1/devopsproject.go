...
type DevOpsProjectInformer interface {
	...
	Lister() v1alpha1.DevOpsProjectLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevopsV1alpha1().DevOpsProjects().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevopsV1alpha1().DevOpsProjects().Watch(options)
			},
		},
		&devopsv1alpha1.DevOpsProject{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devOpsProjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devopsv1alpha1.DevOpsProject{}, f.defaultInformer)
}

func (f *devOpsProjectInformer) Lister() v1alpha1.DevOpsProjectLister {
	return v1alpha1.NewDevOpsProjectLister(f.Informer().GetIndexer())
}
