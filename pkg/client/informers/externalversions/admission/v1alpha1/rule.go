	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AdmissionV1alpha1().Rules().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdmissionV1alpha1().Rules().Watch(context.TODO(), options)
			},
		},
		&admissionv1alpha1.Rule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admissionv1alpha1.Rule{}, f.defaultInformer)
}
