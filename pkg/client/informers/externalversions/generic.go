...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("helmaudits"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Application().V1alpha1().HelmAudits().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("federatedhelmapplications"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Types().V1beta1().FederatedHelmApplications().Informer()}, nil
	case v1beta1.SchemeGroupVersion.WithResource("federatedhelmapplicationversions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Types().V1beta1().FederatedHelmApplicationVersions().Informer()}, nil
