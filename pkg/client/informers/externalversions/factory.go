...
import (
	...
	admission "kubesphere.io/kubesphere/pkg/client/informers/externalversions/admission"
...
func (f *sharedInformerFactory) Admission() admission.Interface {
	return admission.New(f, f.namespace, f.tweakListOptions)
}
