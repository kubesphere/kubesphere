...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubesphere.io/api/cluster/v1alpha1.Cluster":                     schema_pkg_apis_cluster_v1alpha1_Cluster(ref),
		"kubesphere.io/api/cluster/v1alpha1.ClusterCondition":            schema_pkg_apis_cluster_v1alpha1_ClusterCondition(ref),
		"kubesphere.io/api/cluster/v1alpha1.ClusterList":                 schema_pkg_apis_cluster_v1alpha1_ClusterList(ref),
		"kubesphere.io/api/cluster/v1alpha1.ClusterSpec":                 schema_pkg_apis_cluster_v1alpha1_ClusterSpec(ref),
		"kubesphere.io/api/cluster/v1alpha1.ClusterStatus":               schema_pkg_apis_cluster_v1alpha1_ClusterStatus(ref),
		"kubesphere.io/api/cluster/v1alpha1.Connection":                  schema_pkg_apis_cluster_v1alpha1_Connection(ref),
	}
}
