...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubesphere.io/api/tenant/v1alpha1.Workspace":                    schema_pkg_apis_tenant_v1alpha1_Workspace(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceList":                schema_pkg_apis_tenant_v1alpha1_WorkspaceList(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceSpec":                schema_pkg_apis_tenant_v1alpha1_WorkspaceSpec(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceStatus":              schema_pkg_apis_tenant_v1alpha1_WorkspaceStatus(ref),
	}
}
