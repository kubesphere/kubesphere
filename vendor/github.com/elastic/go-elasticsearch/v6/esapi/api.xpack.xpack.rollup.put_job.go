...
func newXPackRollupPutJobFunc(t Transport) XPackRollupPutJob {
	return func(id string, body io.Reader, o ...func(*XPackRollupPutJobRequest)) (*Response, error) {
		var r = XPackRollupPutJobRequest{DocumentID: id, Body: body}
		for _, f := range o {
			f(&r)
		}
		return r.Do(r.ctx, t)
...
//
func (r XPackRollupPutJobRequest) Do(ctx context.Context, transport Transport) (*Response, error) {
	var (
		method string
...
func (f XPackRollupPutJob) WithContext(v context.Context) func(*XPackRollupPutJobRequest) {
	return func(r *XPackRollupPutJobRequest) {
		r.ctx = v
	}
}
