...
func newXPackMLValidateFunc(t Transport) XPackMLValidate {
	return func(body io.Reader, o ...func(*XPackMLValidateRequest)) (*Response, error) {
		var r = XPackMLValidateRequest{Body: body}
		for _, f := range o {
			f(&r)
		}
		return r.Do(r.ctx, t)
...
//
func (r XPackMLValidateRequest) Do(ctx context.Context, transport Transport) (*Response, error) {
	var (
		method string
	...
	path.Grow(len("/_xpack/ml/anomaly_detectors/_validate"))
	path.WriteString("/_xpack/ml/anomaly_detectors/_validate")
...
func (f XPackMLValidate) WithContext(v context.Context) func(*XPackMLValidateRequest) {
	return func(r *XPackMLValidateRequest) {
		r.ctx = v
	}
}
