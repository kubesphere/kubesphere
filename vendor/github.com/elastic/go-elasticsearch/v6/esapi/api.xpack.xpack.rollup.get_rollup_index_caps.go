...
func newXPackRollupGetRollupIndexCapsFunc(t Transport) XPackRollupGetRollupIndexCaps {
	return func(index string, o ...func(*XPackRollupGetRollupIndexCapsRequest)) (*Response, error) {
		var r = XPackRollupGetRollupIndexCapsRequest{Index: index}
		for _, f := range o {
			f(&r)
		}
		return r.Do(r.ctx, t)
...
//
func (r XPackRollupGetRollupIndexCapsRequest) Do(ctx context.Context, transport Transport) (*Response, error) {
	var (
		method string
	...
	path.Grow(1 + len(r.Index) + 1 + len("_xpack") + 1 + len("rollup") + 1 + len("data"))
	path.WriteString("/")
...
func (f XPackRollupGetRollupIndexCaps) WithContext(v context.Context) func(*XPackRollupGetRollupIndexCapsRequest) {
	return func(r *XPackRollupGetRollupIndexCapsRequest) {
		r.ctx = v
	}
}
