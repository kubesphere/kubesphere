...
func newXPackMLDeleteCalendarFunc(t Transport) XPackMLDeleteCalendar {
	return func(calendar_id string, o ...func(*XPackMLDeleteCalendarRequest)) (*Response, error) {
		var r = XPackMLDeleteCalendarRequest{CalendarID: calendar_id}
		for _, f := range o {
			f(&r)
		}
		return r.Do(r.ctx, t)
...
//
type XPackMLDeleteCalendarRequest struct {
	CalendarID string
...
//
func (r XPackMLDeleteCalendarRequest) Do(ctx context.Context, transport Transport) (*Response, error) {
	var (
		method string
...
func (f XPackMLDeleteCalendar) WithContext(v context.Context) func(*XPackMLDeleteCalendarRequest) {
	return func(r *XPackMLDeleteCalendarRequest) {
		r.ctx = v
	}
}
