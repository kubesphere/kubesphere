...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubesphere.io/api/cluster/v1alpha1.Label":                       schema_kubesphereio_api_cluster_v1alpha1_Label(ref),
		"kubesphere.io/api/cluster/v1alpha1.LabelList":                   schema_kubesphereio_api_cluster_v1alpha1_LabelList(ref),
		"kubesphere.io/api/cluster/v1alpha1.LabelSpec":                   schema_kubesphereio_api_cluster_v1alpha1_LabelSpec(ref),
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"joinFederation": {
						SchemaProps: spec.SchemaProps{
							Description: "Join cluster as a kubefed cluster Deprecated: will be removed in the next version.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"enable": {
						SchemaProps: spec.SchemaProps{
							Description: "Desired state of the cluster Deprecated: will be removed in the next version.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"config": {
						SchemaProps: spec.SchemaProps{
							Description: "Config represents the custom helm chart values used when installing the cluster",
							Type:        []string{"string"},
							Format:      "byte",
						},
					},
					"externalKubeAPIEnabled": {
						SchemaProps: spec.SchemaProps{
							Description: "ExternalKubeAPIEnabled export kube-apiserver to public use a lb type service if connection type is proxy",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"configz": {
						SchemaProps: spec.SchemaProps{
							Description: "Configz is status of components enabled in the member cluster. This is synchronized with member cluster every amount of time, like 5 minutes. Deprecated: this field will be removed in the future version.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
...
func schema_kubesphereio_api_cluster_v1alpha1_Label(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubesphere.io/api/cluster/v1alpha1.LabelSpec"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubesphere.io/api/cluster/v1alpha1.LabelSpec"},
	}
}

func schema_kubesphereio_api_cluster_v1alpha1_LabelList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubesphere.io/api/cluster/v1alpha1.Label"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubesphere.io/api/cluster/v1alpha1.Label"},
	}
}

func schema_kubesphereio_api_cluster_v1alpha1_LabelSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
