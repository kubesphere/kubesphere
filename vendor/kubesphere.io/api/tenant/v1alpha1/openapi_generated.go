...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubesphere.io/api/tenant/v1alpha1.Workspace":                    schema_kubesphereio_api_tenant_v1alpha1_Workspace(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceList":                schema_kubesphereio_api_tenant_v1alpha1_WorkspaceList(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceSpec":                schema_kubesphereio_api_tenant_v1alpha1_WorkspaceSpec(ref),
		"kubesphere.io/api/tenant/v1alpha1.WorkspaceStatus":              schema_kubesphereio_api_tenant_v1alpha1_WorkspaceStatus(ref),
	}
}
...
func schema_kubesphereio_api_tenant_v1alpha1_Workspace(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubesphere.io/api/tenant/v1alpha1.WorkspaceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubesphere.io/api/tenant/v1alpha1.WorkspaceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubesphere.io/api/tenant/v1alpha1.WorkspaceSpec", "kubesphere.io/api/tenant/v1alpha1.WorkspaceStatus"},
	}
}

func schema_kubesphereio_api_tenant_v1alpha1_WorkspaceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubesphere.io/api/tenant/v1alpha1.Workspace"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubesphere.io/api/tenant/v1alpha1.Workspace"},
	}
}

func schema_kubesphereio_api_tenant_v1alpha1_WorkspaceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_kubesphereio_api_tenant_v1alpha1_WorkspaceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
